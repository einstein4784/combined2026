...
export function DeleteUserButton({ userId, username }: Props) {
  ...
  return (
    <>
      <button
        className="flex h-8 w-8 items-center justify-center rounded-full border border-red-200 bg-white text-red-600 shadow-sm hover:bg-red-50"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
          <div className="w-full max-w-md rounded-lg bg-white p-5 shadow-lg">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-[var(--ic-navy)]">Delete user</h3>
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button className="btn btn-primary bg-red-600 text-white hover:bg-red-700" onClick={onDelete} disabled={loading}>
